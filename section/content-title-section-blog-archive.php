...
$blog_Display_Breadcrumbs_Search_Bar =  ot_get_option('blog_Display_Breadcrumbs_Search_Bar');
$woo_Display_Breadcrumbs_Search_Bar =  ot_get_option('woo_Display_Breadcrumbs_Search_Bar');
$blog_Breadcrumbs_or_Search_Box =  ot_get_option('blog_Breadcrumbs_or_Search_Box');
...
<section class="content_title_section" style="width:100%;">
	<div class="container" >
        ...
        <div class="col-sm-6" style="vertical-align:middle; display:table-cell; float:none; ">	
			...
			<?php } elseif (function_exists('is_shop') and is_shop()) { ?>
           ...
           <?php if (is_category() || is_tag() || is_author() || is_day() || is_month() || is_year()) { }elseif(function_exists('is_shop') and is_shop()){?><p style="margin-bottom:0;"><?php echo $woo_text; ?></p> <?php }elseif(function_exists('is_product_tag') and is_product_tag()){}elseif( function_exists('is_product_category') and is_product_category()){}else{?> 
