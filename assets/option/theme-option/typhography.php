...
$custom_settings['sections'][] = array( 'id' => 'typhography','title' => 'Typhography');
	...
	$custom_settings['settings'][] = array(
        ...
        'desc'        => __('Numeric value only. Example: 14. if you add the numeric value it will be count and pixels. This option will be applied for all general text for the entire site.' , 'SimThemes' ),
        'type'        => 'text',
        'section'     => 'typhography',
	);
