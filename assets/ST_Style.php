...
function style_generator(){
	...
	$output = '';
	$output .= '<style>';
	$output .= 'body, p, ul, li, a{font-size:'.ot_get_option('body_font_size').'px;}';
	...
	$output .= 'h1, .h1, h1 a, .h1 a{font-size:'.ot_get_option('h1_font_size').'px;}';
	$output .= 'h2, .h2, h2 a, .h2 a{font-size:'.ot_get_option('h2_font_size').'px;}';
	$output .= 'h3, .h3, h3 a, .h3 a{font-size:'.ot_get_option('h3_font_size').'px;}';
	$output .= 'h4, .h4, h4 a, .h4 a{font-size:'.ot_get_option('h4_font_size').'px;}';
	$output .= 'h5, .h5, h5 a, .h5 a{font-size:'.ot_get_option('h5_font_size').'px;}';
	$output .= 'h6, .h6, h6 a, .h6 a{font-size:'.ot_get_option('h6_font_size').'px;}';
	...
	$output .= '.navbar-default .navbar-nav > li > a:hover, .navbar-default .navbar-nav > li > a:focus{color:'.$menu_item_hover_color.';}';
	}else{
...
//sticky header
	...
	$output .= '.navbar > .container .navbar-brand{ margin-top:' . $logo_mar_top['0']. $logo_mar_top['1'] . '; margin-bottom:'.$logo_mergin_bottom[0] . $logo_mergin_bottom[1].' }';
			...
			if($Display_Custom_Background){$Display_Custom_Background = $Display_Custom_Background;}else{ $Display_Custom_Background = ot_get_option('Display_Custom_Background');}
...
*/	
	...
	$output .= '.pagination > .active > a, .pagination > .active > span, .woocommerce nav.woocommerce-pagination ul li span.current{background-color:'.$page_ac_bg_color.';}';


	$page_ac_tx_color = ot_get_option('page_ac_tx_color');
	if(!empty($page_ac_tx_color))
	$output .= '.pagination > .active > a, .pagination > .active > span, .woocommerce nav.woocommerce-pagination ul li span.current{color:'.$page_ac_tx_color.';}';


	$page_ac_bg_color_hover = ot_get_option('page_ac_bg_color_hover');
	if(!empty($page_ac_bg_color_hover))
	$output .= '.pagination > .active > a:hover, .pagination > .active > span:hover, .woocommerce nav.woocommerce-pagination ul li span.current:hover{background-color:'.$page_ac_bg_color_hover.';}';
